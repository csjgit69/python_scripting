...
def select_columns(my_table, col_indices):
    ...
    print("*****************************")
    print("Debug select_columns")
    print("col selects:", col_indices)
    print(my_table)
...
def sort_by_column(my_table, col_idx):
    ...
    print("*****************************")
    print("Debug select_columns")
    print("sort_by_column:", col_idx)
    print(my_table)
    # my_table = sorted(my_table,key=lambda x:x[col_idx], reverse=True)
    my_table.sort(key=lambda x:x[col_idx], reverse=True)
    print()
    print(my_table)
    print("*****************************")
